<?php
	...
	if(isset($_POST['add'])){
		...
		if(isset($_FILES['ebook']) && $_FILES['ebook']['name'] != ""){
			...
			$directory_self = str_replace(basename($_SERVER['PHP_SELF']), '', $_SERVER['PHP_SELF']);
			$uploadDirectory = $_SERVER['DOCUMENT_ROOT'] . $directory_self . "bootstrap/ebook/";
			$uploadDirectory .= $image;
			move_uploaded_file($_FILES['ebook']['tmp_name'], $uploadDirectory);
		}


		$query = "INSERT INTO books (`book_isbn`, `book_title`, `book_author`, `book_image`,`ebook`, `book_descr`, `book_price`, `publisherid`) VALUES ('" . $isbn . "', '" . $title . "', '" . $author . "', '" . $image . "', '" . $ebook . "','" . $descr . "', '" . $price . "', '" . $publisherid . "')";
					...
					<div class="container-fluid">
						...
						<form method="post" action="admin_add.php" enctype="multipart/form-data">
								...
								<div class="mb-3">
									...
									<input class="form-control rounded-0" type="file" name="ebook">
								</div>
								<div class="mb-3">
