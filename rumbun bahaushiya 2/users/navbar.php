...
?>
  ...
  <nav>
    <div class="navbar">
      ...
      <div class="logo  " ><a href="../home.php"><img src="logo.png" style=" max-width:180px;width: 300px;"></a></div>
      <div class="nav-links">
        <div class="sidebar-logo">
          <span class="logo-name"><a href="../home.php"><img src="logo.png" style=" max-width:400px;width: 100px;"></a></span>
          <i class='bx bx-x' ></i>
        </div>
        <ul class="links">
      ...
      <div id="profile">
         ...
         <a href="navbar.php" class="delete-btn" onclick="return confirm('logout from the website?');">logout</a> 
         <?php
            }else{
         ?>
